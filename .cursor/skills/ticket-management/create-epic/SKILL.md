...
- `Jira/assets/project/<project>/team.yaml`: `workspace.project.key`, `workspace.ownership.components`, `team.members`, `team.external_members`, `ticketing.supported_work_types`, `ticketing.defaults.assignee_by_work_type.Epic`, `ticketing.defaults.client_id`.
...
- `Jira/assets/global/epic-list.yaml`: conventions、recent_epics（重复检查）；**创建 Epic 后需更新此文件**。
