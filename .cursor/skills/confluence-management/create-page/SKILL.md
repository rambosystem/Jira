...
- **本仓库脚本**：`scripts/confluence_create_page.py`。从 profile 读 confluence\_\*；认证用 `CONFLUENCE_EMAIL`、`ATLASSIAN_API_TOKEN`。支持 `--title`、`--body-file`、`--body-json`、`--jira-url`；按标题先查页，存在则追加、否则新建。
