---
name: my-requests
description: 查询 PIN 项目中分配给当前用户（profile 中 me.account_id）、且状态为 Ready for Technical Review & Backlog 的工单，按状态分组展示。用户说「my pin tickets」「未处理的 pin ticket」「my requests」时使用。
---
